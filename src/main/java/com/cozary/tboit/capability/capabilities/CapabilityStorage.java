...
public class CapabilityStorage implements Capability.IStorage<CapabilityModel> {
    @Nullable
    @Override
    public INBT writeNBT(Capability<CapabilityModel> capability, CapabilityModel instance, Direction side) {
        return instance.serializeNBT();
    }

    @Override
    public void readNBT(Capability<CapabilityModel> capability, CapabilityModel instance, Direction side, INBT nbt) {

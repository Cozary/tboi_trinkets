...
public class ChariotCard extends Item {
    public ChariotCard() {
    ...
    public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity player, Hand hand) {
        ...
        CapabilityModel.setChariotCarActivate(true);
        CapabilityModel.setChariotCarActivate0(true);
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        tooltip.add(new StringTextComponent(TextFormatting.DARK_PURPLE + "" + TextFormatting.ITALIC + "May nothing stand before you"));
    }
}

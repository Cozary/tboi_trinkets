...
public class FoolCard extends Item {
    public FoolCard() {
    ...
    public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity player, Hand hand) {
        ...
        requiredX = info.getSpawnX();
        requiredY = info.getSpawnY();
        requiredZ = info.getSpawnZ();

        player.setPositionAndUpdate(requiredX, requiredY, requiredZ);
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        tooltip.add(new StringTextComponent(TextFormatting.DARK_PURPLE + "" + TextFormatting.ITALIC + "Where journey begins"));
    }
}

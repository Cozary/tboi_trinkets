...
public class BlueFlyEntity extends TameableEntity {

    public BlueFlyEntity(EntityType<? extends BlueFlyEntity> type, World worldIn) {
        super(type, worldIn);
        this.setTamed(false);
    ...
    public void applyEntityCollision(Entity entityIn) {
        ...
        if (livingEntity != this.getOwner() && this.getOwner() != null) {

                entityIn.attackEntityFrom(DamageSource.GENERIC, (float) this.getOwner().getAttribute(Attributes.ATTACK_DAMAGE).getValue());
                this.onKillCommand();
        }
    }
    ...
    public boolean shouldAttackEntity(LivingEntity p_142018_1_, LivingEntity p_142018_2_) {
        if (!(p_142018_1_ instanceof BlueFlyEntity)) {

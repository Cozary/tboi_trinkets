...
public class IsaacHeadEntity extends FlyingEntity implements IMob {
    ...
    /*------Ghast Things-------*/
    private static final DataParameter<Boolean> ATTACKING = EntityDataManager.createKey(IsaacHeadEntity.class, DataSerializers.BOOLEAN);
    /*------Ghast Things-------*/
    private int explosionStrength = 3;
    /*------Wolf Things--------*/

    public IsaacHeadEntity(EntityType<? extends IsaacHeadEntity> type, World worldIn) {
        super(type, worldIn);
    ...
    static class FireballAttackGoal extends Goal {
        private final IsaacHeadEntity parentEntity;
        public int attackTimer;

        public FireballAttackGoal(IsaacHeadEntity blueBabyEntity) {
    ...
    static class LookAroundGoal extends Goal {
        ...
        public LookAroundGoal(IsaacHeadEntity ghast) {
    ...
    static class MoveHelperController extends MovementController {
        ...
        public MoveHelperController(IsaacHeadEntity ghast) {
            super(ghast);
            this.parentEntity = ghast;
        }
    ...
    static class RandomFlyGoal extends Goal {
        ...
        public RandomFlyGoal(IsaacHeadEntity ghast) {
            this.parentEntity = ghast;
